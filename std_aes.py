...
class AES:
    ...
    def trace_encrypt_rounds(self, plaintext):
        ...
        Does not include the initial AddRoundKey (round 0) state.
        """
        assert len(plaintext) == 16
